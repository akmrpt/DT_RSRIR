...
namespace MyWinApp
{
    ...
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
           ...
           // var orastr = "User Id=rsrir;Password=101171;Data Source=202.143.125.108/fyldb;";
          ...
          //  OracleCommand cmd = new OracleCommand("Select USERID,USERNAME,USERPASSWORD from  USERS where USERNAME='" + textBox1.Text + "' and USERPASSWORD='" + maskedTextBox1.Text + "'", con);
            ...
            OracleCommand cmd = new OracleCommand("pr_LoginPass", con);
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.Add("VsFYear", OracleDbType.Varchar2).Value = sFYear;
            cmd.Parameters.Add("VsUserName", OracleDbType.Varchar2).Value = userid;
            cmd.Parameters.Add("VsUserPass", OracleDbType.Varchar2).Value = password;
